...
export class Res<T> extends Array {
	...
	constructor([value, error]: ErrorTuple | OkTuple<T>) {
		super(2);
		this[0] = value;
		this[1] = error;
	}
	 ...
	 * @param {G} fallback - The fallback value to return if no value is present
	 * @returns {T | G} The value if present, fallback otherwise
	 */
