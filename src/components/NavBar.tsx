  ...
  return (
    <div className="bg-white max-w-[1190px] p-[15px] text-center mx-auto flex flex-row justify-between text-xl pr-4">
      ...
      <ul className="flex flex-row text-lg text-customGray  font-light antialiased pl-[66px]">
        <Link
          href={"/"}
          className={`hover:text-customHoverGray ${isActive("/")} p-[8px] pr-[24px]`}
        >
          Work
        </Link>
        <Link
          href={"/about"}
          className={`hover:text-customHoverGray ${isActive("/about")} p-[8px] pr-[24px]`}
        >
          About
        </Link>
        <Link
          href={"/process"}
          className={`hover:text-customHoverGray ${isActive("/process")} p-[8px] pr-[24px]`}
        >
          Process
        </Link>
      </ul>
