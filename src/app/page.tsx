        ...
        <AnimatedSection delay={0.3}>
          ...
          >
            <div className="flex flex-col lg:pl-24 xl:pl-40 max-w-[370px] lg:max-w-[480px]  text-center lg:text-left mt-[30px] md:mt-[52px] lg:mt-[0px]">
              ...
              <h3 className="font-lyondisplayweb lg:text-[3.125rem] md:text-[2.25rem] text-[2rem] text-white  font-bold  mb-[8px] leading-[1.1] lg:leading-none">
        ...
        <AnimatedSection>
          ...
          >
            <div className="flex flex-col justify-center lg:leading-none leading-[1.1] max-w-[380] lg:max-w-[600px] lg:pl-[96px] xl:pl-[120px] text-center lg:text-left lg:mb-2">
              ...
              <h3 className="font-lyondisplayweb text-[2rem] md:text-[2.25rem] lg:text-[3.125rem] text-white leading-none font-bold">
