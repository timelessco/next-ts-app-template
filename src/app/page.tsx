...
import { BASE_URL, PORTFOLIO_ITEMS, SITE_NAME } from "@/utils/siteConfig";
...
// Map portfolio IDs to their images and alt text
const PORTFOLIO_IMAGES = {
	"atlantic-payroll": {
		alt: "Atlantic Payroll mobile app interface showing The Atlantic Plan onboarding screen with three-step business balance restoration process and professional business owner photo",
		src: atlanticPayrollImage,
	},
	bluematter: {
		alt: "Professional man in blue plaid shirt presenting against vibrant blue background, representing Bluematter's healthcare consulting expertise",
		src: bluematterImage,
	},
	photon: {
		alt: "Photon decentralized infrastructure platform homepage with isometric 3D blocks in pink, blue, and yellow representing simplified blockchain infrastructure",
		src: photonImage,
	},
	smallcase: {
		alt: "Smallcase investment platform interface showing portfolio creation screen with stock selection, segmentation, and market cap weighted allocation for finance sector stocks",
		src: smallcaseImage,
	},
} as const;
			...
			<main>
						...
						>
							...
							<div className="flex w-full">
								<div className="mx-auto max-w-[486px] lg:pt-14">
									<NextImage
										alt={PORTFOLIO_IMAGES[atlanticPayroll.id].alt}
										fetchPriority="high"
										priority
										src={PORTFOLIO_IMAGES[atlanticPayroll.id].src}
									/>
								</div>
							</div>
						</StyledNextLink>
						...
						>
							...
							<div className="flex w-full justify-end">
								<div className="mx-auto max-w-160 lg:mx-[initial] lg:pt-15">
									<NextImage
										alt={PORTFOLIO_IMAGES[smallcase.id].alt}
										src={PORTFOLIO_IMAGES[smallcase.id].src}
									/>
								</div>
							</div>
						</StyledNextLink>
				...
				>
					<Container>
						...
						>
							<NextImage
								alt={PORTFOLIO_IMAGES[bluematter.id].alt}
								className="rounded object-cover object-top-right lg:object-center"
								fill
								src={PORTFOLIO_IMAGES[bluematter.id].src}
							/>
						...
						>
							...
							<div className="flex w-full justify-end">
								<div className="mx-auto max-w-[635px] lg:mx-[initial] lg:pt-15">
									<NextImage
										alt={PORTFOLIO_IMAGES[photon.id].alt}
										src={PORTFOLIO_IMAGES[photon.id].src}
									/>
								</div>
							</div>
						</StyledNextLink>
