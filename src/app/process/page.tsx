	...
	return (
		<>
			<main>
				...
				>
					<NextImage
						alt="Two team members collaborating at a whiteboard, discussing design solutions with colorful sticky notes and sketches on the wall"
						className="mx-auto"
						fetchPriority="high"
						priority
						...
						<div className="mx-auto flex max-w-80 flex-wrap justify-center py-4 sm:max-w-150 lg:max-w-230 lg:justify-between lg:py-10">
							...
							<div className="relative w-110 sm:flex sm:justify-between sm:pb-12">
								<div className="absolute top-[38%] left-[-35%] h-max w-full -rotate-90 sm:-top-10 sm:left-1/2 sm:w-[252px] sm:-translate-x-1/2 sm:rotate-0 lg:top-[-55px]">
									<NextImage
										alt="Curved arrow connecting Research and Strategy to Design and Execute phases, labeled 'Evolve'"
										src={EvolveArrowImage}
									/>
								...
								<div className="absolute bottom-[48%] left-[34%] h-max w-full -rotate-90 sm:bottom-2.5 sm:left-1/2 sm:w-[252px] sm:-translate-x-1/2 sm:rotate-0 lg:bottom-[-5px]">
									<NextImage
										alt="Curved arrow connecting Execute and Design back to Strategy and Research phases, labeled 'Measure'"
										src={MeasureArrowImage}
									/>
			...
			<script
				{...createSchemaScript(
					createBreadcrumbSchema([
						...
						{ name: "Process", url: PROCESS_PAGE_URL },
					]),
				)}
			/>
