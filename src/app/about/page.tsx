	...
	return (
		<>
			<main>
				...
				>
					<NextImage
						alt="Timeless office at night with illuminated storefront displaying the company name, showcasing modern interior with workstations, lounge area, and warm lighting through floor-to-ceiling windows"
						fetchPriority="high"
						priority
				...
				>
					<Container>
						...
						<div className="mx-auto flex max-w-230 flex-wrap sm:pt-8 sm:pb-13">
							...
							>
								<NextImage
									alt="Placeholder avatar for potential team member with 'You' text, linking to careers page"
