...
import gregAvatarImage from "../../images/greg-avatar.png";
import justinAvatarImage from "../../images/justin-avatar.png";
import mikaelAvatarImage from "../../images/mikael-avatar.png";
import ryanAvatarImage from "../../images/ryan-avatar.png";
import vasanthAvatarImage from "../../images/vasanth-avatar.png";
import {
	...
	return (
		...
		>
			<Container className="relative">
				<h2
					className="text-[13px] leading-[1.2] font-bold tracking-[1.97px] text-[#07122C]/55 uppercase md:text-[15px]"
				...
				<TestimonialEmblaCarouselWrapper className="touch-pan-y touch-pinch-zoom ease-out-quad select-none [-webkit-tap-highlight-color:transparent] [backface-visibility:hidden] [&.is-draggable]:cursor-grab [&.is-dragging]:cursor-grabbing">
					<ol className="flex">
								...
								>
									<div className="mx-auto flex max-w-140 flex-col">
										...
										<div className="flex flex-col items-center">
											...
											<h4 className="text-lg leading-[1.5] tracking-[0.3px] text-[#07122C]/65">
												{position}
											</h4>
										</div>
									</div>
