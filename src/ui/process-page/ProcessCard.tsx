...
export function ProcessCard(props: ProcessBoxProps) {
	...
	return (
		<div className="relative z-1 transition-all duration-300 ease-in-out hover:scale-110">
			<ProcessCardClient className="mx-auto my-[25px] flex size-[165px] cursor-pointer flex-col items-center justify-center rounded-[9px] bg-white shadow-[0_0_1px_0_rgba(0,0,0,0.20),0_1px_2px_0_rgba(0,0,0,0.07)] transition-shadow duration-300 ease-in-out hover:shadow-[3px_5px_40px_-2px_rgba(0,0,0,0.10),0px_1px_7px_0px_rgba(0,0,0,0.07)] sm:m-[15px] sm:size-50 lg:m-0">
				<Icon
